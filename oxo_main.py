...
def check_game_over():
    ...
    result = game_board.get_result(1)
    if result is None:
        return False
    elif result > 0:
        font = pygame.font.Font(None, 60)
        game_over_text = font.render("You win!", True, purple, white)
        return True
    elif result < 0:
        font = pygame.font.Font(None, 60)
        game_over_text = font.render("You lose!", True, purple, white)
        return True
    else:
        font = pygame.font.Font(None, 60)
